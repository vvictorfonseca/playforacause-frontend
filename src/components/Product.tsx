...
export default function Product(props: IProduct) {
  ...
  return (
    <div className="transform h-96 bg-white w-64 transition duration-500 hover:scale-110 flex flex-col justify-center items-center p-1 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
