...
- Ao abrir o site todos os produtos são exbidos ao usuário. Obs: O primeiro carregamento de página pode demorar um pouco devido ao período de reativaçao do banco de dados, que é desativado após um período de inatividade (deploy do banco de dados e back end feito através da versão free do Render).
